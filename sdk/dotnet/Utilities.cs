...
namespace Lbrlabs.PulumiPackage.Launchdarkly
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/BinaryBrilliance";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Lbrlabs.PulumiPackage.Launchdarkly.version.txt");
    ...
    internal sealed class LaunchdarklyResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LaunchdarklyResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
